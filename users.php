    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $location_arr=array();
                $location_qry = $conn->query("SELECT * FROM `location_list` where location_id in (SELECT location_id FROM user_list) order by `location` asc");
                ...
                <tr>
                    ...
                    <td class="py-0 px-1">
                        <?php echo ($row['type'] == 1)? "Administrator" : 'Cashier - '.$location_arr[$row['location_id']] ?>
                    </td>
