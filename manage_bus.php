...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM `bus_list` where bus_id = '{$_GET['id']}'");
...
<div class="container-fluid">
    <form action="" id="bus-form">
        <input type="hidden" name="id" value="<?php echo isset($bus_id) ? $bus_id : '' ?>">
