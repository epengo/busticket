...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Bus Station Ticketing Booth System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'routes_price')? 'active' : '' ?>" href="./?page=routes_price">Routes Price List</a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'ticketing')? 'active' : '' ?>" href="./?page=ticketing">Ticketing</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'transaction_report')? 'active' : '' ?>" href="./?page=transaction_report">Report</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
